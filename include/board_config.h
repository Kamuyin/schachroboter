...
#define BOARD_ROW_0_PORT    DT_NODELABEL(gpiof)
#define BOARD_ROW_0_PIN     1
#define BOARD_ROW_1_PORT    DT_NODELABEL(gpiof)
#define BOARD_ROW_1_PIN     0
#define BOARD_ROW_2_PORT    DT_NODELABEL(gpiod)
#define BOARD_ROW_2_PIN     1
#define BOARD_ROW_3_PORT    DT_NODELABEL(gpiod)
#define BOARD_ROW_3_PIN     0
#define BOARD_ROW_4_PORT    DT_NODELABEL(gpiog)
#define BOARD_ROW_4_PIN     0
#define BOARD_ROW_5_PORT    DT_NODELABEL(gpioe)
#define BOARD_ROW_5_PIN     1
#define BOARD_ROW_6_PORT    DT_NODELABEL(gpiog)
#define BOARD_ROW_6_PIN     9
#define BOARD_ROW_7_PORT    DT_NODELABEL(gpiog)
#define BOARD_ROW_7_PIN     12

#define BOARD_COL_0_PORT    DT_NODELABEL(gpioe)
#define BOARD_COL_0_PIN     4
#define BOARD_COL_1_PORT    DT_NODELABEL(gpioe)
#define BOARD_COL_1_PIN     5
#define BOARD_COL_2_PORT    DT_NODELABEL(gpiof)
#define BOARD_COL_2_PIN     2
#define BOARD_COL_3_PORT    DT_NODELABEL(gpiof)
#define BOARD_COL_3_PIN     8
#define BOARD_COL_4_PORT    DT_NODELABEL(gpiof)
#define BOARD_COL_4_PIN     9
#define BOARD_COL_5_PORT    DT_NODELABEL(gpiog)
#define BOARD_COL_5_PIN     1
#define BOARD_COL_6_PORT    DT_NODELABEL(gpioe)
